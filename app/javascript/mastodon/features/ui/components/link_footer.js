    ...
    return (
      <div className='link-footer'>
        ...
        <p>
          ...
          {' '}
          <a href='https://github.com/fedired-dev/fedired/wiki' target='_blank'><FormattedMessage id='footer.about' defaultMessage='About' /></a>
          {DividingCircle}
          <a href='https://github.com/fedired-dev/fedired/' rel='noopener noreferrer' target='_blank'><FormattedMessage id='footer.source_code' defaultMessage='View source code' /></a>
          {DividingCircle}
          v{version}
        </p>
